...
public:
	...
	virtual Eigen::Vector3f getDirection(const Eigen::Vector3f& surfaceLocation) override
	{
		...
		// *** YOUR CODE HERE ***
		std::cout << "Error: Ambient lights do not have a direction " << std::endl;
	...
	virtual Eigen::Vector3f getLightLocation() override
	{
		...
		// *** YOUR CODE HERE ***
		std::cout << "Error: Ambient lights do not have a location " << std::endl;
		return Eigen::Vector3f::Zero();
		// *** END YOUR CODE ***
	}
};
...
public:
	...
	virtual Eigen::Vector3f getLightLocation() override
	{
		...
		// *** YOUR CODE HERE ***
		std::cout << "Error: Directional lights do not have a location " << std::endl;
		return Eigen::Vector3f::Zero();
		// *** END YOUR CODE ***
	}
};	
...
public:
	...
	virtual Eigen::Vector3f getIntensityAt(const Eigen::Vector3f& surfaceLocation) override
	{
		...
		// *** YOUR CODE HERE ***
		Eigen::Vector3f dir = (surfaceLocation - _location).normalized();
		float cosTheta = dir.dot(_direction);
